...
Benchmarks live in `openeval/benchmarks/` and use a fully offline mock model for reproducibility.

Measured on **2026-03-20** with `uv run benchmarks/run_all.py` (see `openeval/benchmarks/results.json`).
...
- `openeval/examples/01_basic_qa.py`
- `openeval/examples/02_openai_eval.py`
- `openeval/examples/03_compare_models.py`
- `openeval/examples/04_rag_eval.py`
- `openeval/examples/05_chatbot_eval.py`
- `openeval/examples/06_code_eval.py`
- `openeval/examples/07_custom_scorer.py`
- `openeval/examples/08_cicd_integration.py`

## Contributing

See `openeval/CONTRIBUTING.md`.

## License

MIT — see `openeval/LICENSE`.
